"""Shared compositing for Phase 2 backends.
...
fallback. No behavior change from ciagan's original private function —
see ciagan/NOTICE.md for this extraction.

A feathered-alpha alternative was tried and removed after round-2
calibration found it didn't fix ganonymization's "real face shows through"
issue (the effect turned out to be the generator's own output quality, not
a compositing-stage leak) — see ganonymization/NOTICE.md's
anti-bleed-through entry for the full test.
"""
