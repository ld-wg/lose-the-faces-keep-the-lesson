# Vendored, verbatim, from dvl-tum/ciagan's source/arch/arch_unet_flex.py.
# Source: https://github.com/dvl-tum/ciagan/blob/38d0eac9d03d3970607a59b43f8041dfac05887d/source/arch/arch_unet_flex.py
# License: MIT (see ../vendor/LICENSE) — see ../NOTICE.md for provenance details.
#
# Only `Generator` is instantiated by `../backend.py`; `Discriminator` (also
# defined in this file) is training-only and unused at inference.
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
